      ...
      <div className="checkout-layout">
        <section className="checkout-form-panel" aria-label="Checkout form">
          ...
          <form className="checkout-form">
            ...
            <input placeholder="First name" defaultValue={account?.first_name || ""} />
            <input placeholder="Last name" defaultValue={account?.last_name || ""} />

            <label className="checkout-search-field checkout-field--full">
              <input placeholder="Address" defaultValue={account?.address || ""} />
              <Search size={19} strokeWidth={1.8} />
            </label>

            <input className="checkout-field--full" placeholder="Apartment, suite, etc. (optional)" />
            <input placeholder="City" />
            <input placeholder="Postcode" />

            <label className="checkout-search-field checkout-field--full">
              <input placeholder="Phone" defaultValue={account?.phone || ""} />
